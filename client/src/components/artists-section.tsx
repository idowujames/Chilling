...
export default function ArtistsSection() {
  const artists = [
    ...
    },
    {
      ...
      achievement: "Rock Chart #1 album and festival headliner",
      streams: "95M+ streams",
      image: "https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&h=400",
    },
    {
      ...
      genre: "Jazz/Neo-Soul",
      achievement: "Jazz Album of the Year and international tours",
      streams: "45M+ streams",
      image: "https://images.unsplash.com/photo-1516280440614-37939bbacd81?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&h=400",
    },
    {
      ...
      achievement: "Country Music Award winner and platinum single",
